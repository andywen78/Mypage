...
<div class="not-prose my-6 grid grid-cols-2 gap-2.5 sm:grid-cols-3 md:grid-cols-4">
  <div class="flex items-center gap-2.5 rounded-md border border-ink/10 bg-paper px-3 py-2 font-mono text-sm text-ink-soft"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/csharp/csharp-original.svg" alt="" class="h-5 w-5" loading="lazy" /><span>C#</span></div>
  <div class="flex items-center gap-2.5 rounded-md border border-ink/10 bg-paper px-3 py-2 font-mono text-sm text-ink-soft"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" alt="" class="h-5 w-5" loading="lazy" /><span>Python</span></div>
...
<div class="not-prose my-6 grid grid-cols-2 gap-2.5 sm:grid-cols-3 md:grid-cols-4">
  <div class="flex items-center gap-2.5 rounded-md border border-ink/10 bg-paper px-3 py-2 font-mono text-sm text-ink-soft"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dotnetcore/dotnetcore-original.svg" alt="" class="h-5 w-5" loading="lazy" /><span>ASP.NET MVC</span></div>
  <div class="flex items-center gap-2.5 rounded-md border border-ink/10 bg-paper px-3 py-2 font-mono text-sm text-ink-soft"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dot-net/dot-net-original.svg" alt="" class="h-5 w-5" loading="lazy" /><span>WebAPI</span></div>
...
<div class="not-prose my-6 grid grid-cols-2 gap-2.5 sm:grid-cols-3 md:grid-cols-4">
  <div class="flex items-center gap-2.5 rounded-md border border-ink/10 bg-paper px-3 py-2 font-mono text-sm text-ink-soft"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/visualstudio/visualstudio-plain.svg" alt="" class="h-5 w-5" loading="lazy" /><span>Visual Studio</span></div>
  <div class="flex items-center gap-2.5 rounded-md border border-ink/10 bg-paper px-3 py-2 font-mono text-sm text-ink-soft"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" alt="" class="h-5 w-5" loading="lazy" /><span>Git</span></div>
  <div class="flex items-center gap-2.5 rounded-md border border-ink/10 bg-paper px-3 py-2 font-mono text-sm text-ink-soft"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg" alt="" class="h-5 w-5" loading="lazy" /><span>GitHub</span></div>
  <div class="flex items-center gap-2.5 rounded-md border border-ink/10 bg-paper px-3 py-2 font-mono text-sm text-ink-soft"><img src="https://cdn.simpleicons.org/githubactions" alt="" class="h-5 w-5" loading="lazy" /><span>GitHub Actions</span></div>
  <div class="flex items-center gap-2.5 rounded-md border border-ink/10 bg-paper px-3 py-2 font-mono text-sm text-ink-soft"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/powershell/powershell-original.svg" alt="" class="h-5 w-5" loading="lazy" /><span>PowerShell</span></div>
</div>
...
Daily use of LLM tools for code review, security policy drafting, documentation, threat-model brainstorming, and accelerating internal tooling development.
